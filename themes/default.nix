...
# in modules/system/stylix.nix. The selected base16 palette is the single
...
# Pure-builtins on purpose: the theme registry is imported from
# modules/system/stylix.nix, which is evaluated while options are built.
